...
Per an undated interview with Pandora staff, an online article suggests that Pandora draws on "almost 75 billion points of feedback" across metrics like number of thumbs up or down, number of skips, number of station listens, location of listening, time of day and length of time of listening, and others (Lawton 2017). All of this feedback seeds some "70 different algorithms: 10 analyze content, 40 process collective intelligence, and then another 30 do personalized filtering" (Lawton 2017). 
